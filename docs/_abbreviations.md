...
*[Logit]: Raw model score before probabilities are computed. Logits are the raw, unnormalized scores generated by the final layer of a classification model. They represent the model's initial "confidence" for each class before being converted into probabilities.
